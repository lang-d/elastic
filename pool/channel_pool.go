...
// GetClient 从pool中取一个连接
func (c *channelPool) GetClient() (interface{}, error) {
	conns := c.getConns()
	if conns == nil {
...
// PutClient 将连接放回pool中
func (c *channelPool) PutClient(conn interface{}) error {
	if conn == nil {
